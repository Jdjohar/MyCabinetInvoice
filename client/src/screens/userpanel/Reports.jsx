...
export default function Reports() {
    ...
    const fetchTotalReceivedAmount = async () => {
        try {
            ...
            const response = await fetch(`https://mycabinet.onrender.com/api/currentMonthReceivedAmount2/${userid}?startOfMonth=${moment(startDate).format('YYYY-MM-DD')}&endOfMonth=${moment(endDate).format('YYYY-MM-DD')}`);
