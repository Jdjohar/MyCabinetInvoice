...
export default function Editcustomer() {
    ...
    const fetchCustomerData = async () => {
        try {
            const response = await fetch(`https://mycabinet.onrender.comapi/getcustomers/${customerId}`);
    ...
    const handleSaveClick = async () => {
        try {
            ...
            const response = await fetch(`https://mycabinet.onrender.comapi/updatecostomerdata/${customerId}`, {
                method: 'POST',
                headers: {
