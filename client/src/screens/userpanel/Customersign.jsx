...
.text-end {
  ...
  const fetchEstimateData = async () => {
    try {
      ...
      const response = await fetch(`https://mycabinet.onrender.com/api/getemailestimatedata/${estimateId}`, {
        // headers: {
  ...
  const fetchtransactiondata = async () => {
    try {
      // const userid = localStorage.getItem("userid");
      // const authToken = localStorage.getItem('authToken');
      const response = await fetch(`https://mycabinet.onrender.com/api/getemailtransactiondata/${estimateId}`, {
        // headers: {
        //   'Authorization': authToken,
        // }
      });
  ...
  const handleSignatureClick = async () => {
    ...
    try {
      ...
      if (checkJson.hasSignature) {
        ...
        const updateResponse = await fetch(`https://mycabinet.onrender.com/api/updatecustomersignature/${encodeURIComponent(estimateData._id)}`, {
          method: 'PUT',
          headers: {
  ...
  const handleDocumentComplete = async () => {
    try {
      ...
      const emailResponse = await fetch('https://mycabinet.onrender.com/api/send-estimate-signed-email', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
