...
.text-end {
  ...
  const fetchinvoiceData = async () => {
    try {
      ...
      const response = await fetch(`https://mycabinet.onrender.com/api/getemailinvoiceData/${invoiceId}`, {
        // headers: {
  ...
  const fetchsignupdata = async () => {
    try {
      ...
      // const userid =   localStorage.getItem("userid");
      // const authToken = localStorage.getItem('authToken');
      const response = await fetch(`https://mycabinet.onrender.com/api/getemailsignupdata/${userId}`, {
        // headers: {
        //   'Authorization': authToken,
        // }
      });
  ...
  const fetchtransactiondata = async () => {
    try {
      // const userid = localStorage.getItem("userid");
      // const authToken = localStorage.getItem('authToken');
      const response = await fetch(`https://mycabinet.onrender.com/api/getemailtransactiondata/${invoiceId}`, {
        // headers: {
        //   'Authorization': authToken,
        // }
      });
  ...
  const fetchOwnerData = async () => {
    try {
      ...
      // const authToken = localStorage.getItem('authToken');
      const response = await fetch(`https://mycabinet.onrender.com/api/getemailownerdata/${ownerId}`, {
        // headers: {
        //   'Authorization': authToken,
        // }
      });
  ...
  const handleSignatureClick = async () => {
    ...
    try {
      ...
      if (checkJson.hasSignature) {
        ...
        const updateResponse = await fetch(`https://mycabinet.onrender.com/api/updatecustomersigninv/${encodeURIComponent(invoiceData._id)}`, {
          method: 'PUT',
          headers: {
...
//     try {
//         const response = await fetch('https://mycabinet.onrender.com/api/customersignature', {
//             method: 'POST',
//             headers: {
//                 'Content-Type': 'application/json',
//                 // 'Authorization': authToken,
...
// };
  ...
  const handleDocumentComplete = async () => {
    try {
      ...
      const emailResponse = await fetch('https://mycabinet.onrender.com/api/send-Invoice-signed-email', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
  ...
  //     // Send email request to backend
  //     const response = await fetch('https://mycabinet.onrender.com/api/send-Invoice-signed-email', {
  //       method: 'POST',
  //       headers: {
  //         'Content-Type': 'application/json',
  //       },
