...
export default function Edititem() {
    ...
    const fetchitemData = async () => {
        try {
            const response = await fetch(`https://mycabinet.onrender.comapi/getitems/${itemId}`);
    ...
    const handleSaveClick = async () => {
        try {
            ...
            const response = await fetch(`https://mycabinet.onrender.comapi/updateitemdata/${itemId}`, {
                method: 'POST',
                headers: {
