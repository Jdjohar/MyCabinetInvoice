...
export default function Editteam() {
    ...
    const fetchteamData = async () => {
        try {
            const response = await fetch(`https://mycabinet.onrender.comapi/getteamdata/${teamid}`);
    ...
    const handleSaveClick = async () => {
        try {
            ...
            const response = await fetch(`https://mycabinet.onrender.comapi/updateteamdata/${teamid}`, {
                method: 'POST',
                headers: {
