...
export default function Editteam() {
    ...
    const fetchteamData = async () => {
        try {
            const response = await fetch(`http://invoice-n96k.onrender.com/api/getteamdata/${teamid}`);
    ...
    const handleSaveClick = async () => {
        try {
            ...
            const response = await fetch(`http://invoice-n96k.onrender.com/api/updateteamdata/${teamid}`, {
                method: 'POST',
                headers: {
