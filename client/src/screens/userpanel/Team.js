...
export default function Team() {
    ...
    const fetchdata = async () => {
        try {
            ...
            const response = await fetch(`http://invoice-n96k.onrender.com/api/teammemberdata/${userid}`);
    ...
    const handleDeleteClick = async (teamid) => {
        try {
            const response = await fetch(`http://invoice-n96k.onrender.com/api/delteammember/${teamid}`, {
                method: 'GET'
            });
