...
export default function Invoicedetail() {
    ...
    const fetchinvoicedata = async () => {
        try {
            ...
            const response = await fetch(`http://invoice-n96k.onrender.com/api/getinvoicedata/${invoiceid}`);
    ...
    const fetchtransactiondata = async () => {
        try {
            const userid =  localStorage.getItem("userid");
            const response = await fetch(`http://invoice-n96k.onrender.com/api/gettransactiondata/${invoiceid}`);
            const json = await response.json();
    ...
    const fetchsignupdata = async () => {
        try {
            const userid =  localStorage.getItem("userid");
            const response = await fetch(`http://invoice-n96k.onrender.com/api/getsignupdata/${userid}`);
            const json = await response.json();
  ...
  if (paymentAmount > dueAmount) {
    ...
    try {
      const response = await fetch('http://invoice-n96k.onrender.com/api/addpayment', {
        method: 'POST',
        headers: {
...
//     try {
//       const response = await fetch(`http://invoice-n96k.onrender.com/api/removeData/${invoiceid}`, {
//         method: 'GET',
...
const handleRemove = async (invoiceid) => {
    try {
      const response = await fetch(`http://invoice-n96k.onrender.com/api/deldata/${invoiceid}`, {
        method: 'GET'
      });
...
//       const response = await fetch(`http://invoice-n96k.onrender.com/api/removeInvoiceAndTransactions/${invoiceid}`, {
//         method: 'GET',
//         // Add any required headers or authentication tokens
//       });
