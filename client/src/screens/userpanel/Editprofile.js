...
export default function Editprofile() {
    ...
    const handleSaveClick = async () => {
        try {
            ...
            const response = await fetch(`https://invoice-n96k.onrender.com/api/updatesignupdatadata/${userid}`, {
                method: 'POST',
                body: formData,
            });
                                    ...
                                    <div className="row">
                                        <div className="col-12 col-sm-12 col-md-6 col-lg-6">
                                            <div class="form-group pt-3">
                                                ...
                                                <img src={`https://invoice-n96k.onrender.com/${signupdata.companyImageUrl}`} className='w-25'  alt=""  />
                                           </div>
                                        </div>
