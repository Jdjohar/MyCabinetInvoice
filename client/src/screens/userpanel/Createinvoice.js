...
export default function Createinvoice() {
    ...
    const fetchLastInvoiceNumber = async () => {
        try {
            ...
            const response = await fetch(`https://mycabinet.onrender.comapi/lastinvoicenumber/${userid}`);
...
const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch('https://mycabinet.onrender.comapi/savecreateinvoice', {
        method: 'POST',
        headers: {
