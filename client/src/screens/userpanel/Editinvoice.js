...
export default function Editinvoice() {
    ...
    const fetchdata = async () => {
        try {
            ...
            const response = await fetch(`http://invoice-n96k.onrender.com/api/geteditinvoicedata/${invoiceid}`);
    ...
    const handleSaveClick = async () => {
        try {
            ...
            const response = await fetch(`http://invoice-n96k.onrender.com/api/updateinvoicedata/${invoiceid}`, {
                method: 'POST',
                headers: {
    ...
    const handleDeleteClick = async (itemId) => {
        try {
            ...
            const response = await fetch(`http://invoice-n96k.onrender.com/api/delinvoiceitem/${invoiceData._id}/${itemId}`, {
                method: 'GET'
            });
