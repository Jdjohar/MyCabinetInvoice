...
export default function Editinvoice() {
    ...
    const fetchdata = async () => {
        try {
            ...
            const response = await fetch(`https://mycabinet.onrender.comapi/geteditinvoicedata/${invoiceid}`);
    ...
    const handleSaveClick = async () => {
        try {
            ...
            const response = await fetch(`https://mycabinet.onrender.comapi/updateinvoicedata/${invoiceid}`, {
                method: 'POST',
                headers: {
    ...
    const handleDeleteClick = async (itemId) => {
        try {
            ...
            const response = await fetch(`https://mycabinet.onrender.comapi/delinvoiceitem/${invoiceData._id}/${itemId}`, {
                method: 'GET'
            });
