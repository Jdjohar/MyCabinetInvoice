        ...
        if (!sigCanvas.current.isEmpty()) {
            ...
            try {
                ...
                if (json.hasSignature) {
                    ...
                    const updateResponse = await fetch('https://mycabinet.onrender.com/api/update-ownersignature', {
                        method: 'PUT',
                        headers: {
                    ...
                    const createResponse = await fetch('https://mycabinet.onrender.com/api/ownersignature', {
                        method: 'POST',
                        headers: {
                            'Content-Type': 'application/json',
                            'Authorization': localStorage.getItem('authToken'),
